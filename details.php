...
include('conn/conn.php');
	...
	$get_job="select * from job_post where Job_post_id='$jobpost_id'";

          $run_q=mysqli_query($conn,$get_job);

          while($row_products=mysqli_fetch_array($run_q)){
            
            $emoplyer_id=$row_products['emoplyer_id'];
            $job_type_id=$row_products['job_type_id'];
            $Job_post_date=$row_products['Job_post_date'];
            $Job_last_date=$row_products['Job_last_date'];
            $job_location=$row_products['job_location'];
            $Job_description=$row_products['Job_description'];
        }

        //getting employer feature
        $get_employer="select * from employer_profile where emp_id='$emoplyer_id'";

          $run_q2=mysqli_query($conn,$get_employer);

          while($row_products2=mysqli_fetch_array($run_q2)){
            
            $emp_profile_description=$row_products2['emp_profile_description'];
            $emp_company_url=$row_products2['emp_company_url'];
            $City=$row_products2['City'];
            $emp_logo=$row_products2['emp_logo'];
            $emp_company_name=$row_products2['emp_company_name'];
            $emp_address=$row_products2['emp_address'];
            $apply_at=$row_products2['apply_at'];
        }
?>
...
<body>
    ...
    <div class="row">
    	<div class="col-md-12">
    		<div class="col-md-3">	
    			<img src='Employer/employer_images/<?php echo $emp_logo; ?>'>
    			<br>
    			<h4 style="color:#3a423b;font-family: sans-serif;"><?php
    			echo $emp_company_name;
    			?></h4>

    			<a href='<?php echo $emp_company_url;?>'>Company Website</a>
    		</div>
    		<div class="col-md-9">
    			<br>
    			<br>
    			<br>
    			<br>
    			<h4 style="color:#418ff4;"><em>"<?php echo $emp_profile_description;?>"</em></h4 >
    		</div>
    ...
    <div class="col-md-12">
    	<div class="col-md-8">
    		...
    		<p style="font-size:20px;"><?php echo $Job_description;?></p>
    		<br>
    	...
    	<br>
    	<br>
    		<p style="font-size: 20px;">Job Post Date:<?php echo $Job_post_date;?></p>
    		<p style="color:red;font-family:Impact;font-size: 20px;">Last Date to Apply:<?php echo $Job_last_date;?></p>
    		<p style="font-size: 20px;">Location:<?php echo $City;?></p>
    ...
    <div class="container">
    	<div style="margin-top: 70px;" class="col-md-12">
    		<p style="font-size:20px;">Address: <em><?php echo $emp_address;?></em></p>	
    		<br><br>
    		<p style="font-size:20px;color:green;font-weight: bold;">Send your Resume at: <?php echo $apply_at;?></p>
    	</div>
